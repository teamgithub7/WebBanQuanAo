...
function addGH(productId,productGia,productImg,productName,productSl){
    ...
    var trcontent = `<tr>   <td data-th="Product" >     <div class="row">       <div class="img-sp"><img src="${productImg}"  width="100"></div> <input type="text" class="add_id" value="${productId}" readonly style="display: none;">        <div class="sp">          <h4 >${productName}</h4>        </div>      </div>    </td>  <td class="giasp_1" >${productGia}</td>  <td ><input class="slgsp" style="width: 50px; height: 20px;"  value="${productSl}" min="1" max="10" type="number"> </td>  <td class="thanh_tien">   300.000  </td>    <td class="actions" >  <button class="bt-Delete" >Delete</button>    </td>   </tr>`
